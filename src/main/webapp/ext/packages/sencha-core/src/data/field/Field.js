...
Ext.define('Ext.data.field.Field', {
     ...
     *   item's {@link Ext.data.reader.Json#cfg-root root} Array. Defaults to the field name. If a function is passed,
     ...
     *      });
     *
     * If the name of the generated {@link Ext.data.Association association} or other aspects
    ...
    /**
     * Gets converter for this field. See {@link #convert}.
